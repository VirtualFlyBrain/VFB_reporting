        ...
        for paper in papers:
            try:
                ...
                for neuron in neurons:
                    if 'skeleton_ids' not in neuron:
                        log_error(f"Missing skeleton_ids for neuron in {paper['name']} at {URL}", neuron)
                        continue
...
if __name__ == '__main__':
    ...
    LEG40 = ["https://radagast.hms.harvard.edu/catmaidvnc", 61, "publication", ["neuron name"], "LEG40"]
