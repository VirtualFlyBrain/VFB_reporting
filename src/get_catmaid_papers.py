...
if __name__ == '__main__':
    ...
    gen_cat_skid_report_officialnames("https://vnc1.catmaid.virtualflybrain.org", 1, "publication", "Name", "VNC1").to_csv("../VFB_reporting_results/EM_CATMAID_VNC1_skids.tsv", sep="\t", index=False)
