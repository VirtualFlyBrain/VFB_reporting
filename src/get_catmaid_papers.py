...
def gen_cat_paper_report(URL, PROJECT_ID, paper_annotation, report_name):
...
def gen_cat_skid_report(URL, PROJECT_ID, paper_annotation, report_name):
...
def gen_cat_skid_report_officialnames(URL, PROJECT_ID, paper_annotation, name_annotations, report_name):
    """Gets IDs and names of papers in CATMAID, then skids for the neurons in each paper and returns a dataframe.
