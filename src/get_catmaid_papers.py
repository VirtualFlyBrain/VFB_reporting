...
if __name__ == '__main__':
    gen_cat_skid_report_officialnames("https://l1em.catmaid.virtualflybrain.org", 1, "papers", "neuron name", "L1EM").to_csv("../VFB_reporting_results/EM_CATMAID_L1_skids.tsv", sep="\t", index=False)
